...
export default function DeletedReportsTable(props: Props) {
  return <ReportTable {...props} title="Taarifa zilizofutwa" description="Rejesha au futa kabisa taarifa zilizowekwa kwenye kumbukumbu ya taka." detailBasePath="/reports/deleted" />;
}
